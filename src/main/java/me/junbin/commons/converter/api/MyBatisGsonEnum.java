...
import me.junbin.commons.converter.api.mybatis.MyBatisEnum;

/**
 * @author : Zhong Junbin
 * @email : <a href="mailto:junbinzhong@linkcm.com">发送邮件</a>
 * @createDate : 2017/5/28 15:58
 * @description :
 */
public interface MyBatisGsonEnum<E extends Enum<E>> extends GsonEnum<E>, MyBatisEnum<E> {
